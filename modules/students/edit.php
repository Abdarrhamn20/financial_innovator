...
// جلب المراحل بناءً على مدرسة الطالب
$stages = getStages($student['school_id']);
...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    if (empty($errors)) {
        $stmt = $pdo->prepare("SELECT COUNT(*) FROM students WHERE student_code = ? AND id != ?");
    ...
    if (empty($errors)) {
        try {
            ...
            $student['current_stage_id'] = $stage_id;
            $student['name'] = $name;
            ...
            // تحديث المراحل إذا تغيرت المدرسة
...
<head>
    ...
    <title>تعديل طالب - المبتكر المالي</title>
    ...
    <style>
        ...
        .student-info-card .info-item .number.transactions {
            color: #3182ce;
        }
            ...
            <div class="content-area">
                <div class="page-header">
                    <h2>
                        ...
                        تعديل: <?php echo htmlspecialchars($student['name']); ?>
                    </h2>
                    <div class="header-actions">
                        <a href="view.php?id=<?php echo $student['id']; ?>" class="btn-back">
                ...
                <div class="student-info-card">
                    ...
                    <div class="info-item">
                        <span class="number transactions"><?php echo htmlspecialchars($student['school_name']); ?></span>
                        <span class="label">🏫 المدرسة</span>
                    </div>
                    <div class="info-item">
                        <span class="number" style="color: #805ad5;"><?php echo htmlspecialchars($student['stage_name'] ?? 'غير محدد'); ?></span>
                ...
                <div class="form-container">
                    ...
                    <div class="form-subtitle">
                        قم بتحديث المعلومات الأساسية للطالب
                    </div>

                    <form method="POST" id="editStudentForm" onsubmit="return validateForm()">
                        <div class="form-row">
                            ...
                            <div class="form-group">
                                ...
                                <select id="stage_id" name="stage_id">
                                    ...
                                    <option value="<?php echo $stage['id']; ?>" 
                                        <?php echo $student['current_stage_id'] == $stage['id'] ? 'selected' : ''; ?>>
                                        <?php echo htmlspecialchars($stage['name']); ?>
                                        (<?php echo formatLibyanCurrency($stage['fee_amount']); ?>)
                                    </option>
                                    <?php endforeach; ?>
                                </select>
                                <div class="help-text">المرحلة الدراسية الحالية للطالب</div>
                            </div>
                        </div>
                        ...
                        <div class="form-group">
                            ...
                            <textarea id="address" name="address" 
                                      placeholder="أدخل عنوان الطالب"><?php echo htmlspecialchars($student['address']); ?></textarea>
                        ...
                        <div class="form-group">
                            ...
                            <select id="status" name="status" required>
                                ...
                                <option value="graduated" <?php echo $student['status'] == 'graduated' ? 'selected' : ''; ?>>متخرج</option>
                            </select>
